                    ...
                    <div className="signin-card">
                        <div className="card-form">
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="input-with-icon">
                                        ...
                                        <button
                                            ...
                                            style={{ position: 'absolute', right: 10, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', padding: 0, color: '#8a6f66' }}
                                        >
                                            {showPassword ? (
                            ...
                            <div className="btn-social">
                                <button aria-label="Continue with Google" className="btn-google"><span className="social-icon">G</span>Continue with Google</button>
                                <button aria-label="Continue with Facebook" className="btn-facebook"><span className="social-icon">f</span>Continue with Facebook</button>
                            </div>
                        </div>
                    </div>
                </div>
